...
- Size: Number of people per transaction
...
### Key Insights
1. Saturday has the highest total spending, indicating peak customer activity occurs on weekends.
...
4. Customer activity is higher on weekends with groups size 2 and 4 being the most frequent. This suggests that moderate sized groups drive majority of transactions and represent the core customer segment.
...
- Average transaction Value: 19.79
- Total Tips: 731.58
